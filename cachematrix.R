## makeCacheMatrix defines and returns four functions for storing and retrieving the matrix and its inverse. The inverse is stored in a variable that is scoped to the function.
